...
const enmt_1:string = 'External Ears-Nose'
const enmt_2:string = 'Canals-TM Exam'
const enmt_3:string = 'Hearing Assessment'
const enmt_4:string = 'Mucosa-Sept-Turb'
const enmt_5:string = 'Lips-Teeth-Gums'
const enmt_6:string = 'Oropharynx Exam'
const neck_1:string = 'Neck Exam'
const neck_2:string = 'Thyroid Exam'
const respiratory_1:string = 'Respiratory Effort'
const respiratory_2:string = 'Chest Percussion'
const respiratory_3:string = 'Chest Palpation'
const respiratory_4:string = 'Lungs Auscultation'
const cardiovascular_1:string = 'Heart Palpation'
const cardiovascular_2:string = 'Heart Auscultation'
const cardiovascular_3:string = 'Carotid Arteries'
const cardiovascular_4:string = 'Abdominal Aorta'
const cardiovascular_5:string = 'Femoral Arteries'
const cardiovascular_6:string = 'Pedal Pulses'
const cardiovascular_7:string = 'Extremities'
const breasts_1:string = 'Breasts Inspection'
const breasts_2:string = 'Breasts Palpation'
const gastrointestinal_1:string = 'Abdomen Exam'
const gastrointestinal_2:string = 'Liver-Spleen'
const gastrointestinal_3:string = 'Hernia'
const gastrointestinal_4:string = 'Anus-Perineum-Rectum'
const gastrointestinal_5:string = 'Stool Occult'
const genitourinary_female_1:string = 'Genitalia'
const genitourinary_female_2:string = 'Urethra'
const genitourinary_female_3:string = 'Bladder'
const genitourinary_female_4:string = 'Cervix'
const genitourinary_female_5:string = 'Uterus'
const genitourinary_female_6:string = 'Adnexa'
const genitourinary_male_1:string = 'Scrotum'
const genitourinary_male_2:string = 'Penis'
const genitourinary_male_3:string = 'Prostate'
const lymphatic_1:string = 'Neck Nodes'
const lymphatic_2:string = 'Axillae Nodes'
const lymphatic_3:string = 'Groin Nodes'
const lymphatic_4:string = 'Generalized'
const musculoskeletal_1:string = 'Gait-Station'
const musculoskeletal_2:string = 'Digits-Nails'
const musculoskeletal_3:string = 'Joints-Bones-Muscles'
const skin_1:string = 'Skin Inspection'
const skin_2:string = 'Skin Palpation'
const neurologic_1:string = 'Cranial Nerves'
const neurologic_2:string = 'DTR Exam'
const neurologic_3:string = 'Sensory Exam'
const psychiatric_1:string = 'Judgment-Insight'
const psychiatric_2:string = 'Orientation TPP'
const psychiatric_3:string = 'Recent Remote Memory'
const psychiatric_4:string = 'Mood-Affect'
